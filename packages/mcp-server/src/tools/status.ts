/**
 * cortivex_status — Check the status of a running or completed pipeline.
 */
...
export async function statusTool(input: StatusInput): Promise<{ content: Array<{ type: string; text: string }> }> {
...
function formatRun(run: PipelineRun): string {
