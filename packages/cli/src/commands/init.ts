...
export async function initCommand(options: { force?: boolean }): Promise<void> {
  ...
  if (!options.force) {
    try {
      ...
      console.log(
        chalk.yellow('  Cortivex is already initialized in this directory.')
      );
      console.log(
        chalk.gray('  Use --force to reinitialize.')
      );
      return;
    } catch {
  ...
  console.log('');
  console.log(
    chalk.bold.cyan('  Initializing Cortivex...')
  );
  console.log('');
  ...
  console.log(
    chalk.green('  +') + chalk.gray(` ${CORTIVEX_DIR}/mesh/.gitignore`)
  );
  ...
  console.log(
    chalk.green('  +') + chalk.gray(` ${CORTIVEX_DIR}/config.json`)
  );
...
`;
  ...
  console.log(
    chalk.green('  +') + chalk.gray(' .claude/mcp.json (cortivex server added)')
  );
  ...
  console.log(
    chalk.white('    cortivex list') +
      chalk.gray('        — see available pipelines')
  );
  console.log(
    chalk.white('    cortivex run full-review') +
      chalk.gray(' — run your first pipeline')
  );
  console.log(
    chalk.white('    cortivex run --dry-run') +
